...
const Contact = () => {
  return (
     ...
     <Typography component="div" sx={{margin:"50px",paddingTop:"40px",paddingBottom:"40px"}}>
   <div class="grid items-center justify-items-center gap-x-4 gap-y-10 lg:grid-cols-2 mt-0">
         ...
         <img
           alt="Contact us"
           class="hidden max-h-full w-[400px] rounded-lg object-cover lg:block"
